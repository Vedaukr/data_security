...
Revision ID: 7178e805fca3
Revises: 
Create Date: 2020-12-11 00:47:16.998576
...
def upgrade():
    ...
    op.create_index(op.f('ix_user_password_salt'), 'user', ['password_salt'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_user_password_salt'), table_name='user')
